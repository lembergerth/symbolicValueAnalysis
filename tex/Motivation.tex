...
\begin{tikzpicture}[->,>=stealth, mynode/.style={circle, draw, minimum size=0.5cm}, every node/.style={font=\small}]
  ...
  \node[mynode] (0) [label=0:{$\{a \rightarrow \top, b \rightarrow \top \}$}]{0};
  \node[mynode] (1) [below = 0.5cm of 0, label=0:{$\{a \rightarrow \top, b \rightarrow \top \}$}]{1};
  \node[mynode] (2) [below left = 1cm of 1]{2};
  \node[mynode] (4) [below right = 1cm of 1]{4};
  \node[mynode] (3) [below = 0.5cm of 2, label=west:{$\{a \rightarrow \top, b \rightarrow \top \}$}]{3};
  \node[mynode] (5) [below = 0.5cm of 4, label=0:{$\{a \rightarrow \top, b \rightarrow \top \}$}]{5};
  \node[mynode] (6) [below right = 0.8cm of 3, label=north:merge, label=0:{$\{a \rightarrow \top, b \rightarrow \top \}$}]{6};
